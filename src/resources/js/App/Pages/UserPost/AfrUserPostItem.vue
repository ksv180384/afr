    ...
    <div class="post-footer">
      ...
      <div>
        <template v-if="currentUserId === post.user.id">
          <Link :href="route('user.post.edit', { id: post.id })">
...
<style scoped>
.post-item{
  @apply bg-sky-50 p-2 border-b border-sky-700 px-4;
}
...
.post-footer{
  @apply flex justify-between border-t border-blue-100 pt-2 mt-2;
}
</style>
