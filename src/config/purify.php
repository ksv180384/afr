    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title],ul,ol,li,p[style],br,span,img[width|height|alt|src|style],blockquote,table[class|style],tbody,thead,tr,td[colspan|rowspan],th[colspan|rowspan]',
